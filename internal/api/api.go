...
func (s *Servidor) rutasDeLaAPI() []ruta {
	return []ruta{
		...
		{"/v1/provincial/novedades", s.verNovedadesProvinciales},
		...
		{"/v1/vencimientos", s.buscarVencimientos},
		{"/v1/vencimientos/hoy", s.verVencimientosDelDia},
		{"/v1/vencimientos/proximos", s.verVencimientosProximos},
		{"/v1/vencimientos/cambios", s.verCambiosDeVencimientos},
		{"/v1/vencimientos/impuestos", s.verImpuestosDeVencimientos},
